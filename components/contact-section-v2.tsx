...
function SimpleInput(props: React.InputHTMLAttributes<HTMLInputElement>) {
  return (
    <input
      {...props}
      className={`bg-white border-2 border-[#EB993C] focus:border-[#EB993C] focus:ring-[#EB993C] rounded-md text-base lg:text-lg py-3 lg:py-4 px-4 w-full text-[#324A6D] ${
        props.className ?? ""
      }`}
    />
  );
...
function SimpleTextarea(
  ...
  return (
    <textarea
      {...props}
      className={`bg-white border-2 border-[#EB993C] focus:border-[#EB993C] focus:ring-[#EB993C] rounded-md resize-none text-base lg:text-lg py-3 lg:py-4 px-4 w-full text-[#324A6D] ${
        props.className ?? ""
      }`}
    />
  );
    ...
    >
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div
          ...
          style={{ transitionDelay: "100ms" }}
        >
          <div className="rounded-2xl p-6 sm:p-8 lg:p-12 xl:p-16 border-4 border-[#EB993C] bg-gradient-to-br from-[#1F447B] via-[#3A6B9F] to-[#1F447B] relative overflow-hidden">
