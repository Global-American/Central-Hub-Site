...
export default function OurBrandsSection() {
  ...
  return (
    <section ref={sectionRef} id="brands" className="relative h-screen overflow-hidden bg-[#f6fdfe]">
      {/* Section Header */}
      <div className="absolute top-16 left-0 right-0 z-50 px-4 md:px-8 pt-8 bg-gradient-to-b from-[#f6fdfe] via-[#f6fdfe] to-transparent pb-8">
