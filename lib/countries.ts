/**
 * Countries with ISO 3166-1 alpha-2 codes and international dialling codes.
 * Used by the contact form for the Country dropdown and the phone prefix.
 * Flag icons come from the `flag-icons` package via `fi fi-<code>` classes.
 */
export type Country = {
  /** ISO 3166-1 alpha-2, upper case */
  code: string;
  name: string;
  /** International dialling code, e.g. "+44" or "+1 242" */
  dial: string;
};
